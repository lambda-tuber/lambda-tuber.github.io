...
#### 135回
  + [商業簿記](https://www.youtube.com/watch?v=SWvr2qaX6xE)
    ...
    + セール・アンド・リースバック。
      ...
      + リース資産計上：備品／リース債務
      + 期末：減償／減累、__<span style="color: red;">長前／減償</span>__
      + ソフトウエア償却、__<span style="color: red;">毎期減損</span>__を含めて計上。
  + 会計学(動画なし)
    + リースの貸手の処理
...
#### 132回
  ...
  + 工業簿記(動画なし) 標準工程別総合原価計算。
    ...
    + 加重平均標準単価による差異分析は__<span style="color: green;">没</span>__。
...
#### 131回
  ...
  + 原価計算(動画なし) 予算実績差異分析。__<span style="color: red;">純額分析(要因分析)。</span>__ただし、総額分析(項目分析)もあり。
...
+ [商業簿記 第3問](https://www.youtube.com/watch?v=CVKpD9HFhdY)
  ...
  + __<span style="color: green;">当座預金 100 ／ 未払金 100</span>__見渡し小切手。費用科目は変更せず、未払金にする。
...
+ 工業簿記
  ...
  + 作業屑。軽微の場合、__<span style="color: green;">現金 100 ／ 雑収入 100</span>__で営業外利益。
...
+ 商業簿記
  ...
  + 事業分離。関連会社になる場合は、逆取得にならない。パーチェス適用。
+ 会計学
  + 棚卸資産の評価損
